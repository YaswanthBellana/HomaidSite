...
contactUsEl.addEventListener('click', function(){
  window.location.href = './Contact/contactPage.html';
});
loginEl.addEventListener('click',function(){
  window.location.href = './Login/signInSignUp.html';
});
loginEl2.addEventListener('click',function(){
  window.location.href = './Login/signInSignUp.html';
});
cookingBtnEl.addEventListener('click',function(){
  window.location.href = './CookingForm/cookingPage.html';
});
cleaningBtnEl.addEventListener('click',function(){
  window.location.href = './CLeaning/cleaningSub.html';
})
